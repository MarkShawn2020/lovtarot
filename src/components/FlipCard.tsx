...
export function FlipCard({ card, position, delay, onFlipComplete }: Props) {
  ...
  return (
    <div className="h-full flex flex-col items-center">
      {/* 位置标签 */}
      <span
        className="text-primary text-sm font-serif opacity-0 mb-3 shrink-0"
      ...
      {/* 卡片名称 */}
      <h3
        className="mt-2 text-foreground text-sm font-medium font-serif opacity-0 text-center shrink-0"
        style={{
      ...
      <p
        className="text-muted-foreground/60 text-xs opacity-0 text-center shrink-0"
        style={{
